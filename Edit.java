...
public class Edit extends salesforceBaseClass {
	@Test
	   ...
	   public  void Update() throws InterruptedException {
		...
		dashbord.click();
		 ...
		 edit.sendKeys("Divyabharath",Keys.ENTER);
		 

		   
		 WebElement mouse = driver.findElement(By.xpath("(//span[text()='Divyabharath'])/ancestor::lightning-formatted-url"));
      mouse.click();
		 ...
		 driver.findElement(By.xpath("(//div[@class='slds-form-element__control']//input[@class='slds-input'])[2]")).sendKeys("hi");   
